...
const About = () => {
    return ( 
        <div className="about">
            ...
            <br></br>
            <h3>What are my professional goals?</h3>
            <div className="about-text">
                My goal is to land a position in a field that I am passionate about and already knowledgable in.  I would love to work in a role as a developer for a fashion company, gaming company, or HVAC/R company.  I feel it is much more fulfilling to work on projects where you are passionate about the product.
            </div>
            <br></br>
        </div>
     )
